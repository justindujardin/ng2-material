...
export function main() {
  ...
  describe('Peekaboo', () => {
    ...
    describe('[md-peekaboo]', () => {
      it('should be inactive by default', injectAsync([], () => {
      ...
      describe('breakAction', () => {
        it('should be undefined by default', injectAsync([], () => {
          return setup().then((api: IPeekabooFixture) => {
            expect(api.peek.breakAction).toBeUndefined();
          });
        }));
        it('should be set by attribute', injectAsync([], () => {
        ...
        it('should be set by binding', injectAsync([], () => {
      ...
      ['breakXs', 'breakSm', 'breakMd', 'breakLg', 'breakXl'].forEach((size: string) => {
        describe(size, () => {
          it('should be -1 by default', injectAsync([], () => {
            return setup().then((api: IPeekabooFixture) => {
          ...
          it('should work with all breakpoint sizes', injectAsync([], () => {
            return setup(`<div md-peekaboo [${size}]="sizeBinding"></div>`).then((api: IPeekabooFixture) => {
