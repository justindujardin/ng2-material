...
describe('Component: DataTableSelectableRows', () => {
  ...
  beforeEachProviders(() => [DataTableSelectableRowsComponent]);
  beforeEach(inject([TestComponentBuilder], function (tcb: TestComponentBuilder) {
    builder = tcb;
  }));

  it('should inject the component', inject([DataTableSelectableRowsComponent],
      (component: DataTableSelectableRowsComponent) => {
